...
ActiveRecord::Schema.define(version: 20200418221157) do
  ...
  create_table "merchant_discounts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["discount_id"], name: "index_merchant_discounts_on_discount_id"
  ...
  add_foreign_key "merchant_discounts", "discounts"
