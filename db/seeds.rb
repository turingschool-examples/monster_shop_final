...
admin = User.create(name: 'Sal', email: 'sa@gmail.com', password: 'sa', role: 'admin')
admin = megan.users.create(name: 'Sal', email: 'merchant@gmail.com', password: 'sa', role: 'merchant_admin')
