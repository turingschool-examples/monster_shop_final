...
jess = User.create!(name: "Jess E", address: "412 E 945th St", city: "Gotham City", state: "NY", zip: 10612, email: "lasers_are_cool@turing.io", password: "foobar", role: 1, merchant_id: megan.id)
