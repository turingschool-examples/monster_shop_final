Rails.application.routes.draw do
  ...
  post '/orders', to: 'user/orders#create', as: :create_order
  get '/orders/new', to: 'user/orders#new', as: :new_order
  get '/profile/orders', to: 'user/orders#index'
  get '/profile/orders/:id', to: 'user/orders#show'
  get '/profile/orders/:id/edit', to: 'user/orders#edit', as: :edit_order
  patch '/profile/orders/:id', to: 'user/orders#update', as: :update_order
  ...
  patch '/profile/addresses/:id', to: 'user/addresses#update', as: :update_user_address
  delete '/profile/addresses/:id', to: 'user/addresses#destroy', as: :delete_address
