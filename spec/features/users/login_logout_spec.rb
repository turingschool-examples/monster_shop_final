...
RSpec.describe 'User Login and Log Out' do
  describe 'A registered user can log in' do
    describe 'As a default user' do
      before :each do
        ...
        @address1 = @user.addresses.create!(streetname: '123 Main St', city: 'Denver', state: 'CO', zip: 80218 )
      end
    ...
    describe 'As a merchant user' do
      before :each do
        ...
        @address2 = @m_user.addresses.create(streetname: '123 Main St', city: 'Denver', state: 'CO', zip: 80218 )
      end
    ...
    describe 'As admin user' do
      before :each do
        ...
        @address3 = @admin.addresses.create(streetname: '123 Main St', city: 'Denver', state: 'CO', zip: 80218)
      end
  ...
  describe 'A registered user can not log in with bad credentials' do
    before :each do
      @user = User.create(name: 'Megan', email: 'megan@example.com', password: 'securepassword')
      @address4 = @user.addresses.create(streetname: '123 Main St', city: 'Denver', state: 'CO', zip: 80218)
    end
  ...
  describe 'A logged in user can log out' do
    before :each do
      @user = User.create(name: 'Megan', email: 'megan@example.com', password: 'securepassword')
      @address5 = @user.addresses.create(streetname: '123 Main St', city: 'Denver', state: 'CO', zip: 80218)
    end
