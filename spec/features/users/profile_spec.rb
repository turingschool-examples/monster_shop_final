...
RSpec.describe "User Profile Path" do
  describe "As a registered user" do
    before :each do
      ...
      @address1 = @user.addresses.create!( streetname: '123 Main St', city: 'Denver', state: 'CO', zip: 80218, nickname: 0)
      @admin = User.create!(name: 'Megan', email: 'admin@example.com', password: 'securepassword')

      @address2 = @admin.addresses.create!( streetname: '13 Main St', city: 'Denver', state: 'CO', zip: 80218, nickname: 0)
