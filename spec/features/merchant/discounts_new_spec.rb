...
describe 'As a merchant employee' do
  ...
  describe 'when I add a new discount record' do
    before :each do
      click_on("Add New Discount")
    end
    it "I see a form to add a discount's item, threshold, and discount rate" do
    ...
    it "once I fill in the form completely, I'm redirected to the merchant/discounts page and see my new discount record" do
      
      select('Ogre', from: 'discount[item_id]')
      fill_in "discount[threshold]", with: 50
      fill_in "discount[discount]", with: 0.5
