...
RSpec.describe 'Discount Index Page' do
  describe 'As a Merchant Employee' do
    before :each do
      ...
      @merchant_user = @megan.user.create!(name: "Hope", street_address: "456 Space st", city: "Space", state: "CO", zip: 80111, email_address: "Hope@example.com", password: "superEasyPZ", role: 1)
