...
RSpec.describe 'Merchant Discounts Edit Page' do
  describe 'As an employee of a merchant' do
    before :each do
      ...
      @discount_1 = @merchant_1.discounts.create!(quantity: 2, amount: 4)
      @discount_2 = @merchant_1.discounts.create!(quantity: 10, amount: 15)
      @discount_2 = @merchant_1.discounts.create!(quantity: 15, amount: 20)
