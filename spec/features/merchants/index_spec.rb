...
RSpec.describe 'Merchant Index Page' do
  describe 'As a visitor' do
    before :each do
      @morgan = Merchant.create!(name: 'Morgans Marmalades', address: '123 Main St', city: 'Denver', state: 'CO', zip: 80218, enabled: true)
  ...
  describe 'As an Admin' do
    before :each do
      ...
      @admin = User.create(name: 'Morgan', address: '123 Main St', city: 'Denver', state: 'CO', zip: 80218, email: 'morgan@example.com', password: 'securepassword', role: :admin)
    ...
    it 'I can disable a merchant' do
      ...
      expect(page).to have_content("#{@morgan.name} has been disabled")
      visit '/merchants'
      within "#merchant-#{@morgan.id}" do
    ...
    it 'When I disable a merchant, their items become inactive' do
      page.driver.submit :patch, "/admin/merchants/#{@morgan.id}", {}
