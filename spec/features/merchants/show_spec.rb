...
RSpec.describe 'Merchant Show Page' do
  describe 'As a visitor' do
    before :each do
      ...
      @address1 = @user_1.addresses.create(streetname: "123 market", city: "Denver", state: "CO", zip: 81021)
      @user_2 = User.create!(name: 'Megan', email: 'megan_2@example.com', password: 'securepassword')
      @address2 = @user_2.addresses.create(streetname: "123 market", city: "Denver", state: "IA", zip: 81021)
      @order_1 = @user_1.orders.create!(address_id: @address1.id)
      @order_2 = @user_2.orders.create!(address_id: @address2.id)
      @order_2 = @user_2.orders.create!(address_id: @address2.id)
