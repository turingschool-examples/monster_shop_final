...
RSpec.describe 'Merchant Show Page' do
  describe 'As a visitor' do
    before :each do
      ...
      @user_address_1 = @user_1.addresses.create!(address: '123 Main St', city: 'Denver', state: 'CO', zip: 80218)
      @user_2 = User.create!(name: 'Megan', email: 'megan_2@example.com', password: 'securepassword')
      @user_address_2 = @user_2.addresses.create!(address: '123 Main St', city: 'Denver', state: 'IA', zip: 80218)
      @order_1 = @user_1.orders.create!(address_id: @user_address_1.id)
      @order_2 = @user_2.orders.create!(address_id: @user_address_2.id)
      @order_2 = @user_2.orders.create!(address_id: @user_address_2.id)
