...
RSpec.describe 'Navigation Restrictions' do
  ...
  describe 'As a Default User' do
    before :each do
      ...
      # @address = @user.addresses.create(streetname: '123 Main St', city: 'Denver', state: 'CO', zip: 80218 )
  ...
  describe 'As an Admin' do
    before :each do
      ...
      # @address = @admin.addresses.create(streetname: '123 Main St', city: 'Denver', state: 'CO', zip: 80218, )
