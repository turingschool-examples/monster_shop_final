...
RSpec.describe Merchant do
  ...
  describe 'Instance Methods' do
    before :each do
      ...
      @address1 = @user_1.addresses.create!(streetname: '123 Main St', city: 'Denver', state: 'CO', zip: 80218)
      @user_2 = User.create!(name: 'Megan', email: 'megan_2@example.com', password: 'securepassword')
      @address2 = @user_1.addresses.create!(streetname: '123 Main St', city: 'Denver', state: 'IA', zip: 80218)
      @order_1 = @user_1.orders.create!(address_id: @address1.id)
      @order_2 = @user_2.orders.create!(status: 1, address_id: @address2.id)
      @order_3 = @user_2.orders.create!(status: 1, address_id: @address2.id)
